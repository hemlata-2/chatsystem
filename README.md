...
6. php artisan make:event NewTrade

7. php artisan tinker

 event (new \App\Events\NewTrade('200'))

8. npm install

9. npm install --save-dev laravel-echo pusher-js

10. npm run dev (CODE COMPILED KARTA HAI)

11. composer require laravel/breeze (use for auth , if channel is private channel)
